...
<div class="container">
    <div class="content-l">
        ...
        <ul class="page-container">
                <li><a href="${base}/${column.namePinyin}/index=1">首页</a></li>
                <li><a href="${base}/${column.namePinyin}/index=${lastPage}">上一页</a></li>
                <#if pageCount != 1>
                    <#list 1..pageCount as i>
                        <li><a href="${base}/${column.namePinyin}/index=${i}">${i}</a></li>
                    </#list>
                </#if>
                <#if pageCount <= 1>
                    <li><a href="${base}/${column.namePinyin}/index=1">1</a></li>
                </#if>
                <li><a href="${base}/${column.namePinyin}/index=${nextPage}">下一页</a></li>
                <li><a href="${base}/${column.namePinyin}/index=${pageCount}">尾页</a></li>
        </ul>
    </div>
    <div class="content-r">
