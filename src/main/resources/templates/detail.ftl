    ...
    <div class="content-l">
        ...
        ${article.content}
            ...
            <div class="item-next-prev">
                <a href="${base}/${lastArticle.id}.html" class="fl-l"><strong>上一篇：</strong>${lastArticle.name}</a>
                <a href="${base}/${nextArticle.id}.html" class="fl-r"><strong>下一篇：</strong>${nextArticle.name}</a>
            </div>
            <!-- 推荐 -->
